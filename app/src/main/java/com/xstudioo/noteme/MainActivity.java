...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent splashCall=getIntent();
        boolean flag1=splashCall.getBooleanExtra("flag1",false);
        ...
        if(flag){
            Intent callSplash=new Intent(getApplicationContext(),SplashActivity.class);
            callSplash.putExtra("flag",false);
            flag=flag1;
